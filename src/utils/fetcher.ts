...
export function useGetQuery<Data>(
  ...
  return useQuery<Data>(
    formattedKey,
    getFetcher(process.env.NEXT_PUBLIC_API_BASE_URL + "/api"),
    config
  );
}
...
export function usePostMutation<ExtraArgs, Data>(
  ...
  return useMutation<ExtraArgs, Data>(
    key,
    postJsonFetcher(process.env.NEXT_PUBLIC_API_BASE_URL + "/api"),
    config
  );
}
...
export function deleteFetcher(baseURL: string) {
  return <ExtraArgs>(
    key: string,
    options?: Readonly<{ arg: ExtraArgs }> // This basically for payload.
  ) =>
    fetcher({
      url: baseURL + key,
      init: {
...
export function useDeleteMutation<Data>(
  ...
  return useMutation<unknown, Data>(
    key,
    deleteFetcher(process.env.NEXT_PUBLIC_API_BASE_URL + "/api"),
    config
  );
}
...
export function usePutMutation<Data>(
  ...
  return useMutation<unknown, Data>(
    key,
    putFetcher(process.env.NEXT_PUBLIC_API_BASE_URL + "/api"),
    config
  );
}
...
export function usePatchMutation<Data>(
  ...
  return useMutation<unknown, Data>(
    key,
    patchFetcher(process.env.NEXT_PUBLIC_API_BASE_URL + "/api"),
    config
  );
}
